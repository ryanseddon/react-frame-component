(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react"), require("react-dom"), require("prop-types")) : typeof define === "function" && define.amd ? define([
		"exports",
		"react",
		"react-dom",
		"prop-types"
	], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.ReactFrameComponent = {}, global.React, global.ReactDOM, global.PropTypes));
})(this, function(exports, react, react_dom, prop_types) {
	...
	*/
	...
	var Frame = class extends react.Component {
		...
		renderFrameContents() {
			...
			const contents = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content, {
				contentDidMount,
				contentDidUpdate,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FrameContextProvider, {
					value: {
						document: doc,
	...
	var Frame_default = react.default.forwardRef((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Frame, {
		...props,
		forwardedRef: ref
	}));
	//#endregion
